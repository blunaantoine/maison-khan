...
export default function Home() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      if (res.ok) {
        // Initialize payment
        const paymentRes = await fetch('/api/payments/cinetpay', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
        ...
        if (paymentData.paymentUrl) {
          ...
          if (paymentData.demo) {
            showToast('Démo', 'Commande créée avec succès (mode démo)')
            fetchUserOrders()
          } else {
          ...
          <div className="p-6">
            ...
            {checkoutStep === 'payment' && (
              <div className="space-y-4">
                ...
                <div className="border-t border-[#E5E0DA] pt-4 space-y-2">
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full bg-[#0A0A0A] text-white py-3 uppercase tracking-wider hover:bg-[#6B6560] transition-colors flex items-center justify-center gap-2"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="bg-[#EDE8E1] p-4 text-sm">
                  ...
                  <p className="text-[#6B6560]">"Commander maintenant" vous permet de passer commande et payer plus tard (à la livraison ou en boutique). CinetPay permet un paiement sécurisé immédiat.</p>
                </div>
